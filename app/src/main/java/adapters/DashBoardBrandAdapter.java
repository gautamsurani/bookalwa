 ...
 */
public class DashBoardBrandAdapter extends RecyclerView.Adapter<DashBoardBrandAdapter.ViewHolder> {

    Typeface fonts1;
    private List<DashBoardBrandData> items = new ArrayList<>();
    ...
    public DashBoardBrandAdapter(Context ctx, List<DashBoardBrandData> items) {
        this.ctx = ctx;
        this.items = items;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_dashboard_brands, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        final DashBoardBrandData p = items.get(position);
