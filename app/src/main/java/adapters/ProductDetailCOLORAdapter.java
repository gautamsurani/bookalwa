 ...
 */
public class ProductDetailCOLORAdapter extends RecyclerView.Adapter<ProductDetailCOLORAdapter.ViewHolder> {
    ...
    public ProductDetailCOLORAdapter(Context ctx, List<String> items) {
        this.ctx = ctx;
        this.items = items;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if(ProductDetailActivity.INTChangeForColor==position){
