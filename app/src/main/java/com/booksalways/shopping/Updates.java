...
public class Updates extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LinearLayoutManager mLayoutManager = new LinearLayoutManager(Updates.this);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.setHasFixedSize(true);
        recyclerView.addItemDecoration(new DividerItemDecoration(Updates.this, DividerItemDecoration.VERTICAL_LIST));


        mUpdatesAdapter = new UpdatesAdapter(Updates.this, UpdateNotificationList);
        ...
        mUpdatesAdapter.setOnItemClickListener(new UpdatesAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View view, int which) {
                ...
                Intent intent = new Intent(Updates.this, UpdateViewActivity.class);
        ...
        if (Utils.isNetworkAvailable(getBaseContext())) {
            loading = ProgressDialog.show(Updates.this, "", "Please wait...", false, false);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                Utils.hideKeyboard(Updates.this);
    ...
    private class GetNotificationDetalil extends AsyncTask<Void, Void,
        ...
        protected Api_Model doInBackground(Void... params) {
            try {
                ...
                Api_Model curators = methods.GetAllNOtification("offer_list", StrUserId);
            ...
            if (curators == null) {
                ...
                if (curators.msgcode.toString().equals("0")) {
                    try {
                        ...
                        Utils.showToastShort(e.getMessage().toString(), Updates.this);
    ...
    private void ShowRetryDialog() {
        try {
            final Dialog dialog = new Dialog(Updates.this);
    ...
    public void onBackPressed() {
        ...
        if (StrPage.equalsIgnoreCase("Push")) {
            //finish();
            Intent innew = new Intent(Updates.this, MainActivity.class);
            startActivity(innew);
